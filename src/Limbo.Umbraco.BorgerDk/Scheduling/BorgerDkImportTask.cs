...
public class BorgerDkImportTask : RecurringHostedServiceBase {
    ...
    public BorgerDkImportTask(ILogger<BorgerDkImportTask> logger, BorgerDkService borgerDkService, BorgerDkImportTaskSettings importSettings, TaskHelper taskHelper) : base(logger, HowOftenWeRepeat, DelayBeforeWeStart) {

angular.module("umbraco.resources").factory("borgerDkService", function (editorService) {
    return {
        ...
        editArticle: function (value, config, submit) {

            if (!config) config = { municipality: 0 };

            editorService.open({
                title: "Indsæt artikel",
                size: "medium",
                view: "/App_Plugins/Limbo.Umbraco.Borgerdk/Views/Overlay.html",

angular.module("umbraco").controller("Limbo.BorgerDk.Overlay.Controller", function ($scope, $element, $http, $timeout, borgerDkService, editorService, notificationsService) {
    ...
    function update() {
        ...
        $http.get("/umbraco/backoffice/Limbo/BorgerDk/GetArticleByUrl", { params: params }).then(function (r) {
    ...
    $scope.search = function() {
        editorService.open({
            ...
            //size: "medium",
            view: "/App_Plugins/Limbo.Umbraco.Borgerdk/Views/SearchOverlay.html",
